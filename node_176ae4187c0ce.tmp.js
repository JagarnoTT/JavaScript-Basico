...
let Ano = prompt("Qual seu ano de nascimento? ") // Utilizando prompt para interagir com o usuario;

Ano = Number(Ano)//convertendo a string para numero;
...
var CemAnos =  resultado - 100



console.log(`Você tem ${resultado} anos. Para chegar a 100 anos, faltam ${CemAnos} e você é ${resultado >= 18 == "maior"} ${resultado <= 18 == "menor"}`)
